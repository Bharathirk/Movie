...
import com.movies.watchme.presentation.home.adapters.NowPlayingMovieAdapter.NowPlayingMovieViewHolder
...
class NowPlayingMovieAdapter(
  ...
  inner class NowPlayingMovieViewHolder(private val binding: ItemMovieBinding) :
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NowPlayingMovieViewHolder {
    return NowPlayingMovieViewHolder(
