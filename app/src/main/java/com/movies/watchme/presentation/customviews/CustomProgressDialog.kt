package com.movies.watchme.presentation.customviews

import android.content.Context
import android.view.LayoutInflater
import androidx.appcompat.app.AlertDialog
import com.movies.watchme.databinding.LayoutCustomProgressDialogBinding
...
class CustomProgressDialog(context: Context) : AlertDialog(context) {
  ...
  init {
    binding = LayoutCustomProgressDialogBinding.inflate(LayoutInflater.from(context), null, false)
